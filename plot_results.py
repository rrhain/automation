...
parser.add_option("-p", dest="rootpath", 
        help="Path to Parent Directory/", default=os.getcwd())
...
from numpy import *
from pylab import plot, errorbar, hist, bar

opts.rootpath = os.path.expanduser(opts.rootpath)
# opts.quiet or print("Root path: "+opts.rootpath)
if not opts.quiet:
    print("Root path: "+opts.rootpath)

automationPath = opts.rootpath
plotterPath = opts.rootpath+'/plotting/'
